...
export default function Login() {
 ...
 {/* Right side */}
    <div className="md:flex-1 bg-gradient-to-tr from-green-400 to-green-600 flex flex-col items-center justify-center p-6 hidden md:flex relative overflow-hidden">
  ...
  {/* Right side - form */}
  <div className="md:flex-1 flex items-center justify-center p-8 bg-gray-50">
    <div className="w-full max-w-md bg-white rounded-2xl shadow-2xl p-10 relative overflow-hidden">
      <h2 className="text-4xl font-bold text-gray-800 mb-6 text-center">Bienvenue</h2>
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-5">
        ...
        <div className="relative">
          ...
          <label
            ...
            className={`absolute left-4 transition-all 
              ${identifier ? "top-0 text-sm text-green-500" : "top-4 text-gray-400 text-base"}`}
          >
        ...
        <div className="relative">
          ...
          <label
            htmlFor="password"
            className={`absolute left-4 transition-all 
              ${password ? "top-0 text-sm text-green-500" : "top-4 text-gray-400 text-base"}`}
          >
            Mot de passe
          </label>
        </div>
